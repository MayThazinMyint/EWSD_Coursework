...
// department update >> http://localhost:8000/api/department/update/{department_id_to_update}
...
// department delete >> http://localhost:8000/api/department/delete/{department_id_to_delete}
